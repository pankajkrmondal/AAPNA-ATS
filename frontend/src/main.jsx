...
// Design V3 token contract. FIRST, deliberately: it publishes the type / radius /
// motion / material / density variables that the two stylesheets below consume, and
// a custom property must be declared before the rule that reads it resolves. It
// holds no design decisions — those live in theme/presets/*.js and theme/fonts.js.

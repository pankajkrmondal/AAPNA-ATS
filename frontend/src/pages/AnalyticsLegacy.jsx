...
/**
 * AnalyticsLegacy.jsx — preserved pre-rebrand version of the Analytics page.
 *
 * Kept byte-for-byte as the operational fallback (candidate search/status
 * editing, Zeko interview scheduling/cancellation, Outlook conversation
 * viewer) while the curated `Analytics.jsx` ("Recruitment Analytics")
 * carries the analytics-only content forward. Reachable at
 * /analytics-legacy — not linked from the Dashboard, AdminDashboard module
 * list, or command palette, only the sidebar.
 *
 * Both this file and Analytics.jsx are interim: the whole page is expected
 * to be deprecated once Phase 3 Module 1 ships the real Pipeline Tracker
 * and pipeline analytics becomes a live tab here instead of a mock preview
 * (see docs/phase3/03-DEVELOPMENT-PLAN.md).
 */
export default function AnalyticsLegacy() {

          ...
          if (existingCandidate) {
            if (source === 'vendor_portal') {
              ...
              const tempCandidate = await prisma.rpa_cv_tmp.create({
                data: {
                  ...
                  CurrentCompany: typeof parsed.CurrentCompany === 'object' ? JSON.stringify(parsed.CurrentCompany) : (parsed.CurrentCompany || existingCandidate.CurrentCompany || "AAPNA Infotech"),
            ...
            const newCv = await prisma.rpa_cv.create({
              data: {
                ...
                CurrentCompany: typeof parsed.CurrentCompany === 'object' ? JSON.stringify(parsed.CurrentCompany) : (parsed.CurrentCompany || "N/A"),
